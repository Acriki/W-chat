...
// Login 登录接口
func (c *Auth) Login(ctx *mygin.Context) error {
...
// // Register 注册接口
// func (c *Auth) Register(ctx *mygin.Context) error {
...
// // Logout 退出登录接口
// func (c *Auth) Logout(ctx *mygin.Context) error {
...
// // Refresh Token 刷新接口
// func (c *Auth) Refresh(ctx *mygin.Context) error {
...
// // Forget 账号找回接口
// func (c *Auth) Forget(ctx *mygin.Context) error {
